...
- **\`bot.py\`**: The main script that initializes and runs the Telegram bot.
- **\`database.py\`**: Handles database initialization and connection using SQLAlchemy.
- **\`handlers.py\`**: Contains the logic for user interactions, task creation, and status updates.
